...
export default function ModalLogin({ fechar }) {
    ...
    async function handleGoogleResponse(response) {
        ...
        const resp = await fetch(`${API_URL}/auth/verificar-email`, {
            method: "POST",
                ...
                {!mostrarTermos && (
                    <>
                        ...
                        <p className="log-login-desc">
                            Entre para gerenciar sua conta, acompanhar pedidos e receber comunicações da Missionary Store brasil.
                        </p>
                ...
                {mostrarTermos && (
                    <div className="log-termos-box">
                        ...
                        <ul className="log-termos-lista">
                            ...
                            <li>Autorizo o envio de comunicações essenciais sobre meus pedidos, entregas e informações importantes da Missionary Store brasil.</li>
